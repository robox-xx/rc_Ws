...
(cl:defmethod cl:initialize-instance :after ((m <GpioData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GpioData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rc_msgs-msg:<GpioData> is deprecated: use rc_msgs-msg:GpioData instead.")))

(cl:ensure-generic-function 'gpio_name-val :lambda-list '(m))
(cl:defmethod gpio_name-val ((m <GpioData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:gpio_name-val is deprecated.  Use rc_msgs-msg:gpio_name instead.")
  (gpio_name m))

(cl:ensure-generic-function 'gpio_state-val :lambda-list '(m))
(cl:defmethod gpio_state-val ((m <GpioData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:gpio_state-val is deprecated.  Use rc_msgs-msg:gpio_state instead.")
  (gpio_state m))

(cl:ensure-generic-function 'gpio_type-val :lambda-list '(m))
(cl:defmethod gpio_type-val ((m <GpioData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:gpio_type-val is deprecated.  Use rc_msgs-msg:gpio_type instead.")
  (gpio_type m))
