...
(cl:defmethod cl:initialize-instance :after ((m <LpData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LpData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rc_msgs-msg:<LpData> is deprecated: use rc_msgs-msg:LpData instead.")))
...
(cl:defmethod real-val ((m <LpData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:real-val is deprecated.  Use rc_msgs-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'filtered-val :lambda-list '(m))
(cl:defmethod filtered-val ((m <LpData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_msgs-msg:filtered-val is deprecated.  Use rc_msgs-msg:filtered instead.")
  (filtered m))
