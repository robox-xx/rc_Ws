...
"""autogenerated by genpy from rc_msgs/ChassisCmd.msg. Do not edit."""
import codecs
import sys
...
class ChassisCmd(genpy.Message):
  _md5sum = "7a4c3ac2c507077f490fac95897a32c5"
  _type = "rc_msgs/ChassisCmd"
...
float64 y
float64 z"""
  __slots__ = ['accel','command_source_frame','stamp']
  _slot_types = ['geometry_msgs/Accel','string','time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       accel,command_source_frame,stamp
